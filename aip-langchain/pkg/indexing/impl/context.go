...
func (ictx *indexContext) Index() indexing22.Index {
	return ictx.index
}
...
func (ictx *indexContext) ResolveRelative(options indexing22.ResolveOptions) (collective2.MemoryID, error) {
	//TODO implement me
	panic("implement me")
}
...
func (ictx *indexContext) ResolveMemoryRelative(options indexing22.ResolveOptions) (*collective2.Memory, error) {
