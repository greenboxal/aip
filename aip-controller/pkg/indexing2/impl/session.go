...
type Session struct {
	*Iterator
	...
	index   *Index
	context indexing2.IndexContext
	options indexing2.SessionOptions
...
func NewSession(ctx context.Context, index *Index, options indexing2.SessionOptions) (*Session, error) {
...
func (s *Session) Options() indexing2.SessionOptions {
	return s.options
}

func (s *Session) Branch(ctx context.Context, clock, height int64) (indexing2.Session, error) {
	s.commitMutex.RLock()
...
func (s *Session) Fork(ctx context.Context) (indexing2.Session, error) {
	return s.Branch(ctx, 0, 1)
}

func (s *Session) Split(ctx context.Context) (indexing2.Session, error) {
