...
func (fls *FileLogStore) OpenStream(id logstore2.LogStreamID) (logstore2.LogStream, error) {
	...
	return logstore2.NewLogStream(fls, id, fa, fb)
}
...
func NewFileLogStore(baseDir string) (*FileLogStore, error) {
	...
	s, err := fls.openSegment(logstore2.MakeLSN(0, time.Now()), false, false)
...
func (fls *FileLogStore) Append(ctx context.Context, log logstore2.LogEntry) (logstore2.LogEntryRecord, error) {
	var record logstore2.LogEntryRecord
...
func (fls *FileLogStore) Iterator(options ...logstore2.LogIteratorOption) logstore2.LogIterator {
	return newLogIterator(fls, logstore2.NewLogIteratorOptions(options...))
}
...
func newFileStoreSegment(f *os.File, base logstore2.LSN, readOnly bool) (*fileStoreSegment, error) {
...
func (fss *fileStoreSegment) Seek(lsn logstore2.LSN) error {
	return nil
}

func (fss *fileStoreSegment) Read(current *logstore2.LogEntryRecord) (*logstore2.LogEntryRecord, error) {
	return nil, nil
}

func (fss *fileStoreSegment) Append(record *logstore2.LogEntryRecord) error {
	if fss.readOnly {
...
func (fss *fileStoreSegment) updateHeader(lastOffset uint64, tail logstore2.LSN) error {
	if fss.readOnly {
		return errors.New("segment is read only")
	}
