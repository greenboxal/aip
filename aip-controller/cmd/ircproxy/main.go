...
func main() {
	...
	client := irc2.NewClient(stream, irc2.ClientConfig{
		Nick: nickname,
		User: nickname,
		Pass: "",
		Name: nickname,
		Handler: irc2.HandlerFunc(func(client *irc2.Client, message *irc2.Message) {
	...
	go func() {
		...
		err := client.WriteMessage(&irc2.Message{
			Command: "JOIN",
