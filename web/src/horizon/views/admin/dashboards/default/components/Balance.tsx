...
// Custom components
import Transaction from 'src/horizon/components/dataDisplay/Transaction';
import Card from 'src/horizon/components/card/Card';

// Assets
import balanceImg from 'src/horizon/assets/img/dashboards/balanceImg.png';
import fakeGraph from 'src/horizon/assets/img/dashboards/fakeGraph.png';
import { MdOutlineMoreHoriz, MdDomain, MdElectricCar, MdSchool } from 'react-icons/md';
// Assets
