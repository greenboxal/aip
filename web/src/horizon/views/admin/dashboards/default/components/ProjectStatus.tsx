...
import Menu from 'src/horizon/components/menu/MainMenu';
import IconBox from 'src/horizon/components/icons/IconBox';

import { lineChartDataProjectStatus, lineChartOptionsProjectStatus } from 'src/horizon/variables/charts';
