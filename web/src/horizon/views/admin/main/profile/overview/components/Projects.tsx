...
// Assets
import Project1 from 'src/horizon/assets/img/users/Project1.png';
import Project2 from 'src/horizon/assets/img/users/Project2.png';
import Project3 from 'src/horizon/assets/img/users/Project3.png';
// Custom components
import Card from 'src/horizon/components/card/Card';

import Project from 'src/horizon/views/admin/main/profile/overview/components/Project';
