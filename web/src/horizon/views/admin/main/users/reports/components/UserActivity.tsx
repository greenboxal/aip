...
// Custom components
import BarChart from 'src/horizon/components/charts/BarChart';

import { barChartDataUserActivity, barChartOptionsUserActivity } from 'src/horizon/variables/charts';
