...
import InvoiceTable from 'src/horizon/views/admin/main/account/invoice/components/InvoiceTable';
import tableDataInvoice from 'src/horizon/views/admin/main/account/invoice/variables/tableDataInvoice';
