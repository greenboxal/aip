...
import Rating from 'src/horizon/views/admin/main/account/coursePage/components/Rating';
import Instructor from 'src/horizon/views/admin/main/account/coursePage/components/Instructor';
