...
import Details from 'src/horizon/assets/img/ecommerce/Details.png';
// Custom components
import Card from 'src/horizon/components/card/Card';
import React from 'react';
// Assets
import { MdDownload, MdPrint, MdShare } from 'react-icons/md';
import Content from 'src/horizon/views/admin/main/ecommerce/orderDetails/components/Content';
