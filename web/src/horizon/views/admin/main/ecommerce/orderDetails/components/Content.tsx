...
// Custom components
import ReceiptTable from 'src/horizon/views/admin/main/ecommerce/orderDetails/components/ReceiptTable';
import tableDataReceipt from 'src/horizon/views/admin/main/ecommerce/orderDetails/variables/tableDataReceipt';
